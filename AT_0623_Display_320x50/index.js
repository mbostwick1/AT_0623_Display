...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(218).to({_off:false},0).to({regX:283,scaleX:1,scaleY:1,alpha:1},50,cjs.Ease.elasticOut).to({_off:true},62).wait(1));
	...
	this.instance_6.setTransform(80,250,1,1,0,0,0,80,300);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(125).to({_off:false},0).to({y:300},30,cjs.Ease.cubicInOut).wait(39).to({y:350},29,cjs.Ease.backIn).to({_off:true},107).wait(1));
	...
	this.instance_9.setTransform(242.2,24.05,0.2764,0.2764,0,0,0,166.8,166.1);
	...
	this.instance_10.setTransform(80,250,1,1,0,0,0,80,300);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(55).to({_off:false},0).to({y:300},30,cjs.Ease.cubicInOut).wait(28).to({y:350},29,cjs.Ease.backIn).to({_off:true},188).wait(1));

	// head11
	this.instance_11 = new lib.head11_1();
	this.instance_11.setTransform(80,249,1,1,0,0,0,80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({y:300},30,cjs.Ease.cubicInOut).wait(17).to({y:350},29,cjs.Ease.backIn).to({_off:true},254).wait(1));

	// hand
	this.instance_12 = new lib.hand_1();
	this.instance_12.setTransform(24.1,485.2,1.4865,1.4865,0,0,0,80,300.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({regY:300,scaleX:1,scaleY:1,x:80,y:300},30,cjs.Ease.quartOut).wait(27).to({x:119,y:340},29,cjs.Ease.cubicOut).to({_off:true},244).wait(1));

	// product
	this.instance_13 = new lib.product_1();
	this.instance_13.setTransform(80,300,1,1,0,0,0,80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(18).to({regX:80.1,regY:300.2,scaleX:0.8503,scaleY:0.8503,x:109.15,y:257.2},6,cjs.Ease.cubicOut).to({regX:80,regY:300,scaleX:1,scaleY:1,x:80,y:300},6,cjs.Ease.cubicOut).wait(27).to({alpha:0},29,cjs.Ease.cubicOut).to({_off:true},244).wait(1));
...
p.nominalBounds = new cjs.Rectangle(65.2,-65,315.7,178.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.png?1687326385098", id:"back"},
		{src:"images/cta.png?1687326385098", id:"cta"},
		{src:"images/dots.png?1687326385098", id:"dots"},
		{src:"images/hand.png?1687326385098", id:"hand"},
		{src:"images/head11.png?1687326385098", id:"head11"},
		{src:"images/head21.png?1687326385098", id:"head21"},
		{src:"images/head31.png?1687326385098", id:"head31"},
		{src:"images/head41.png?1687326385098", id:"head41"},
		{src:"images/head42.png?1687326385098", id:"head42"},
		{src:"images/image1.png?1687326385098", id:"image1"},
		{src:"images/image2.png?1687326385098", id:"image2"},
		{src:"images/logo.png?1687326385098", id:"logo"},
		{src:"images/logo_large.png?1687326385098", id:"logo_large"},
		{src:"images/no.png?1687326385098", id:"no"},
		{src:"images/product.png?1687326385098", id:"product"}
	],
	preloads: []
};
